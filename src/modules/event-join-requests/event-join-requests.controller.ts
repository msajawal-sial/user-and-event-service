...
export class EventJoinRequestsController {
  constructor(
    private readonly eventJoinRequestsService: EventJoinRequestsService,
  ) {}
  ...
  @ApiResponse({
    status: 400,
    description: 'Bad Request - Join request already exists',
  })
  ...
  async createEventJoinRequest(
    ...
    return this.eventJoinRequestsService.createEventJoinRequest(
      eventJoinRequest,
      req.user.id,
    );
  }
  ...
  async updateEventJoinRequest(
    ...
    return this.eventJoinRequestsService.updateEventJoinRequest(
      id,
